	...
	return (
		<div>
					...
					<div className="row">
						<div className="col-8 mx-auto text-center">
							...
							<ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
								...
								<li className="list-inline-item">/ &nbsp; <Link to="/about">About</Link>
								</li>
							</ul>
						</div>
					</div>
					...
					<div className="row justify-content-center align-items-center">
						<div className="col-lg-7">
							<div className="section-title">
								<p className="text-primary text-uppercase fw-bold mb-3">About ZDart</p>
								<h2 className="h1 mb-4">Meet the Team Behind <br /> Your Online Success</h2>
								<div className="content pe-0 pe-lg-5">
									<p>Embark on a journey of online success with ZDart, where we believe in delivering personalized, high-quality services tailored to your unique needs and goals. Our team of passionate experts is the driving force behind your exceptional results. Whether it's web development, SEO optimization, content creation, or web hosting, we bring a wealth of expertise and experience to fuel your success.</p>
									<p>We are not just trend followers; we're trendsetters, committed to staying at the forefront of the latest industry trends and technologies. Transparency, clear communication, and unwavering customer satisfaction are at the heart of everything we do. With ZDart, you're not just a client; you're a partner on the path to unlocking your online potential. Trust us to guide you through the digital landscape and elevate your online presence with distinction.</p>
								</div>
							</div>
						</div>
						<div className="col-lg-4 mt-5 mt-lg-0">
							<img loading="lazy" decoding="async" src={abt1} alt="Business Loans For Daily Expenses" className="rounded w-100" />
						</div>
					</div>
				</div>
			</section>
			...
			<section className="about-section section bg-tertiary position-relative overflow-hidden">
				<div className="container">
					<div className="row justify-content-around">
						<div className="col-lg-5">
							...
							<p className="lead">With a commitment to excellence and a focus on customer satisfaction, we strive to empower our clients with the tools they need to succeed in today's digital landscape.</p>
							<div className="content">We are a team of web experts dedicated to helping businesses succeed online. Our mission is to provide a range of services including web vitals optimization, SEO, and custom web development to improve our clients online presence and drive results.</div>
						</div>
						<div className="col-lg-5">
							<div className="section-title">
								<p className="text-primary text-uppercase fw-bold mb-3"></p>
							...
							<p className="lead">At ZDart, we offer a comprehensive suite of web services designed to help your business thrive online. Our offerings include :</p>
							<div className="content">
								<ul>
									<li>We optimize your website for key metrics that impact user experience and so on.</li>
									<li>Our SEO strategies help your website rank higher in search results, increasing visibility.</li>
									<li>Our team of developers creates custom websites that are tailored to meet the unique needs of your business.</li>
								</ul>
							</div>
						</div>
					</div>
				...
				<div className="has-shapes">
					<svg className="shape shape-left text-light" width="381" height="443" viewBox="0 0 381 443" fill="none" xmlns="http://www.w3.org/2000/svg">
						...
						<path d="M349.584 485.51C345.427 455.611 319.469 433 291.58 422.425C263.69 411.85 233.395 410.538 203.984 405.823C174.573 401.092 144.114 391.878 123.982 369.632C88.1716 330.038 98.6628 268.513 93.0817 215.09C84.62 134.258 30.8056 59.8999 -42.6819 27.494" stroke="currentColor" strokeMiterlimit="10" />
						<path d="M364.904 472.013C360.747 442.114 334.789 419.503 306.9 408.928C279.011 398.352 248.716 397.041 219.304 392.326C189.893 387.595 159.434 378.381 139.303 356.135C103.492 316.541 113.983 255.016 108.402 201.593C99.9403 120.76 46.1259 46.4028 -27.3616 13.9969" stroke="currentColor" strokeMiterlimit="10" />
						<path d="M380.24 458.516C376.083 428.617 350.125 406.006 322.236 395.431C294.347 384.856 264.051 383.544 234.64 378.829C205.229 374.098 174.77 364.884 154.639 342.638C118.828 303.044 129.319 241.519 123.738 188.096C115.276 107.264 61.4619 32.906 -12.0255 0.500103" stroke="currentColor" strokeMiterlimit="10" />
					</svg>
					<svg className="shape shape-right text-light" width="406" height="433" viewBox="0 0 406 433" fill="none" xmlns="http://www.w3.org/2000/svg">
						<path d="M101.974 -86.77C128.962 -74.8992 143.467 -43.2447 146.175 -12.7857C148.883 17.6734 142.273 48.1263 139.087 78.5816C135.916 109.041 136.681 141.702 152.351 167.47C180.247 213.314 240.712 218.81 289.413 238.184C363.095 267.516 418.962 340.253 430.36 421.687" stroke="currentColor" strokeMiterlimit="10" />
						...
						<path d="M135.241 -110.238C162.23 -98.3675 176.735 -66.7131 179.443 -36.254C182.151 -5.79492 175.541 24.6581 172.354 55.1134C169.183 85.573 169.948 118.234 185.619 144.002C213.515 189.846 273.98 195.342 322.681 214.716C396.363 244.048 452.23 316.785 463.627 398.219" stroke="currentColor" strokeMiterlimit="10" />
				...
				<div className="container">
					<div className="row justify-content-center">
						<div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
							<div className="icon icon-lg bg-transparent mb-4"><i className="fas fa-mouse-pointer text-primary"></i>
							</div>
							<h3>Contact Us</h3>
							<p className="px-lg-5">Reach out to us through our website or by phone to discuss your needs and receive a quote</p>
						</div>
						<div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
							<div className="icon icon-lg bg-transparent mb-4"><i className="fas fa-file-alt text-primary"></i>
							</div>
							<h3>Review & Approve</h3>
							<p className="px-lg-5">Review the quote and once you're satisfied, you have to approve the quote to proceed </p>
						</div>
						<div className="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
							<div className="icon icon-lg bg-transparent mb-4"><i className="fas fa-briefcase text-primary"></i>
							</div>
							<h3>Confirm & Complete</h3>
							<p className="px-lg-5">We'll then get started on delivering the services you need to achieve your online goals</p>
						</div>
					</div>
				</div>
			</section>
					...
					<div className="row align-items-center">
							...
							<div className="row position-relative gy-4">
								<div className="icon-box-item col-md-6">
									<div className="block bg-white">
										...
										<p className="mb-1">We have a team of experienced & knowledgeable professionals who are dedicated in delivering top-notch web services.</p>
										<br /><br />
									</div>
								</div>
								<div className="icon-box-item col-md-6">
									<div className="block bg-white">
										...
										<p className="mb-0">At ZDart, we recognize the individuality of each business. Our commitment lies in providing custom solutions designed to address the specific needs and goals of every client.</p>
									</div>
								</div>
								<div className="icon-box-item col-md-6">
									<div className="block bg-white">
										...
										<p className="mb-0">We have a strong commitment to delivering quality results and meeting your client expectation.</p>
										<br /><br />
									</div>
								</div>
								<div className="icon-box-item col-md-6">
									<div className="block bg-white">
										...
										<p className="mb-4">We are able to adapt to changing needs and provide solutions that are flexible and scalable.</p>
										<br />
									</div>
								</div>
								<div className="has-shapes">
						...
						<div className="col-lg-6 mt-5 mt-lg-0">
							<div className="section-title ps-0 ps-lg-5">
								<p className="text-primary text-uppercase fw-bold mb-3">VALUES WE PROVIDE</p>
								<h2 className="h1">Our Core Values</h2>
								<div className="content">
									<p>At ZDart, our core values define who we are and guide the way we do business. We believe in providing exceptional service, delivering results-driven solutions, and building strong relationships with our clients</p>
									<p>We are committed to ethical and responsible practices, and we strive to continuously improve and innovate in all that we do. Our goal is to help our clients succeed and achieve their online potential, and we believe that by staying true to our values, we can make that happen.</p>
								</div>
							</div>
						</div>
					</div>
