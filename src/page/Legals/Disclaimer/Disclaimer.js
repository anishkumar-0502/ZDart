...
const Disclaimer = () => {
    ...
    <div className="container">
        ...
        <div className="col-lg-10 mx-auto">
            ...
            <h2 id="application-processing">Consent</h2>
            <ul>
                <li>By using our website, you hereby consent to our disclaimer and agree to its terms.</li>
            </ul>
            <h2 id="application-processing">update</h2>
            <ul>
                <li>Should we update, amend or make any changes to this document, those changes will be prominently posted here.</li>
            </ul>
            </div>
        </div>
        </div>
