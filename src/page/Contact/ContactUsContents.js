                ...
                <div className="row">
                    <div className="col-8 mx-auto text-center">
                        ...
                        <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                            ...
                            <li className="list-inline-item">/ &nbsp; <Link to="/Contact">Contact Us</Link>
                            </li>
                        </ul>
                    </div>
                </div>
		...
		<div className="row justify-content-center align-items-center">
			<div className="col-lg-6">
				<div className="section-title text-center">
					<p className="text-primary text-uppercase fw-bold mb-3">Contact With us</p>
				...
				<div className="shadow rounded p-5 bg-white">
					<div className="row">
						...
						<div className="col-lg-6">
							...
							<form action="https://formcarry.com/s/OAJf1BfBSbu" method="post">
								...
								<div className="form-group mb-4 pb-2">
									...
									<input type="email" className="form-control shadow-none" id="contact_email" name="contact_email" />
								</div>
								<div className="form-group mb-4 pb-2">
									<label htmlFor="exampleFormControlTextarea1" className="form-label">Write Message</label>
									<textarea className="form-control shadow-none" id="exampleFormControlTextarea1" name="message" rows="3"></textarea>
								</div>
