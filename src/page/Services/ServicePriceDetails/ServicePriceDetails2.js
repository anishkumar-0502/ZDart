                ...
                <div className="container">
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Pricing for Scalable App Solutions</h2>
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to="/">Home</Link></li>
                                <li className="list-inline-item">/ <Link to="/ServiceDetails01">Pricing for Scalable App Solutions</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Single platform</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Minimal features</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Basic UI/UX</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Basic testing</li>
                                        </ul>
                                        <a
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Multi-platform</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> APIs integration</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> User authentication</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Moderate testing</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Mid-Level App',
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Real-time features</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> AI/ML integration</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Payment systems</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Complex backend</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Advanced App',
...
export default ServicePriceDetails2;