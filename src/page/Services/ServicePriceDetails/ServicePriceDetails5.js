                ...
                <div className="container">
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Pricing for Cloud Solutions</h2>
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to="/">Home</Link></li>
                                <li className="list-inline-item">/ <Link to="/ServiceDetails01">Pricing for Cloud Solutions</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        <h3 className="card-title mb-2">Basic Cloud Deployment</h3>
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Basic hosting</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Security setup</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Small-scale solutions</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Initial configuration</li>
                                        </ul>
                                        <a
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        <h3 className="card-title mb-2">Cloud Infrastructure</h3>
                                        <h4 className="display-6 mb-3">
                                            {formatPrice(isINR ? 500000 : Math.round(500000 / exchangeRate), isINR ? 'INR' : 'USD')} -
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Scalable infrastructure</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Load balancing</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Auto-scaling</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> AWS/Azure/GCP support</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        <h3 className="card-title mb-2">Enterprise Cloud Solutions</h3>
                                        <h4 className="display-6 mb-3">
                                            {formatPrice(isINR ? 1200000 : Math.round(1200000 / exchangeRate), isINR ? 'INR' : 'USD')} -
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Multi-cloud setup</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Kubernetes support</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> DevOps integration</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Security compliance</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
...
export default ServicePriceDetails5;