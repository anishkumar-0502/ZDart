                ...
                <div className="container">
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Pricing for Quality Assurance</h2>
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to="/">Home</Link></li>
                                <li className="list-inline-item">/ <Link to="/ServiceDetails01">Pricing for Quality Assurance</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        <h3 className="card-title mb-2">Manual Testing</h3>
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Functional testing</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> UI testing</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Performance testing</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Manual approach</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Manual Testing',
                                                isINR ? 3500 : Math.round(3500 / exchangeRate), // Midpoint
                                                isINR ? 'INR' : 'USD'
                                            )}
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        <h3 className="card-title mb-2">Automation Testing</h3>
                                        <h4 className="display-6 mb-3">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Automated scripts</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Selenium/Appium/Cypress</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Regression testing</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Scalable testing</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Automation Testing',
                                                isINR ? 7000 : Math.round(7000 / exchangeRate), // Midpoint
                                                isINR ? 'INR' : 'USD'
                                            )}
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        <h3 className="card-title mb-2">End-to-end QA</h3>
                                        <h4 className="display-6 mb-3">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> End-to-end testing</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Comprehensive QA</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Mid-sized projects</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Detailed reports</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'End-to-end QA',
                                                isINR ? 400000 : Math.round(400000 / exchangeRate), // Midpoint
                                                isINR ? 'INR' : 'USD'
                                            )}
                                            className="btn btn-light rounded-pill px-4 py-2"
                                            target="_blank"
...
export default ServicePriceDetails4;