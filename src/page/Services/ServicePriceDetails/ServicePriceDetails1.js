...
const ServicePriceDetails1 = () => {
    ...
    const enterpriseWebAppPriceUSD = Math.round(enterpriseWebAppPriceINR / exchangeRate); // ~$9,036
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Pricing for Web Design & Development</h2>
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to="/">Home</Link></li>
                                <li className="list-inline-item">/ <Link to="/ServiceDetails01">Pricing for Web Design & Development</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Static, 5-10 pages</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> No backend</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Basic SEO</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Responsive design</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Basic Website',
                                                isINR ? basicWebsitePriceINR : basicWebsitePriceUSD,
                                                isINR ? 'INR' : 'USD'
                                            )}
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Custom-built</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Complex integrations</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Dashboards</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Full support</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Enterprise Web App',
                                                isINR ? enterpriseWebAppPriceINR : enterpriseWebAppPriceUSD,
                                                isINR ? 'INR' : 'USD'
                                            )}
...
export default ServicePriceDetails1;