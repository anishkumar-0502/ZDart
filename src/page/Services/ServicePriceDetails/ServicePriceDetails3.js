...
const ServicePriceDetails3 = () => {
    ...
    // Function to generate WhatsApp link with package details
    const generateWhatsAppLink = (packageName, price, currency) => {
        const formattedPrice = formatPrice(price, currency);
        const message = `Hello, I am interested in booking the ${packageName} package priced at ${formattedPrice}. Can we discuss further?`;
        const encodedMessage = encodeURIComponent(message);
        return `https://wa.me/+918870208686?text=${encodedMessage}`;
    };
            ...
            <section className="page-header bg-tertiary">
                <div className="container">
                    <div className="row">
                        <div className="col-8 mx-auto text-center">
                            <h2 className="mb-3 text-capitalize">Pricing for UI/UX</h2>
                            <ul className="list-inline breadcrumbs text-capitalize" style={{ fontWeight: 500 }}>
                                <li className="list-inline-item"><Link to="/">Home</Link></li>
                                <li className="list-inline-item">/ <Link to="/ServiceDetails01">Pricing for UI/UX</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
                <div className="has-shapes">
                    <svg className="shape shape-left text-light" viewBox="0 0 192 752" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M-55.5959 7.52271C-66.0565 43.9475 -47.4274 83.3312 -20.4214 109.92C6.58466 136.51 41.1549 153.722 72.9328 174.393C104.711 195.064 135.426 221.425 147.449 257.37C168.829 321.322 125.174 386.420 104.356 450.559C72.8494 547.601 97.3965 660.752 166.287 736.018" stroke="currentColor" strokeMiterlimit="10" />
                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-12 text-center mb-5">
                            <h2 className="fw-bold">Choose the Perfect Package</h2>
                            ...
                            <p className="text-muted mt-2">Book a free call to discuss about your business</p>
                            <div className="d-flex justify-content-center align-items-center mb-4">
                                <span className="me-3">Package in ₹ INR</span>
                                <div className="form-check form-switch">
                                    <input
                                        ...
                                        id="billingToggle"
                                        checked={!isINR}
                                        onChange={() => setIsINR(!isINR)}
                                    />
                                </div>
                                <span className="ms-3">Package in $ USD</span>
                            </div>
                        </div>
                            ...
                            <div className="row g-4 justify-content-center">
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Basic wireframes</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Visual design</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Small-scale projects</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Limited iterations</li>
                                        </ul>
                                        <a
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Basic wireframes</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Simple layouts</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Initial concepts</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Limited revisions</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-white text-dark rounded-4 p-4 shadow-sm">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Interactive prototypes</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Tool-specific design</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> User testing support</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Moderate revisions</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        <h3 className="card-title mb-2">Design System (Enterprise Level)</h3>
                                        <h4 className="display-6 mb-3">
                                            {formatPrice(isINR ? 350000 : Math.round(350000 / exchangeRate), isINR ? 'INR' : 'USD')} -
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Enterprise design system</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Extensive research</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Scalable prototypes</li>
                                            <li className="mb-2"><i className="fas fa-check text-dark me-2"></i> Full support</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                ...
                                <div className="col-md-5">
                                    <div className="pricing-card bg-purple text-white rounded-4 p-4">
                                        ...
                                        <ul className="list-unstyled mb-4">
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Design systems</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> User research</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Interactive prototypes</li>
                                            <li className="mb-2"><i className="fas fa-check text-white me-2"></i> Multiple iterations</li>
                                        </ul>
                                        <a
                                            href={generateWhatsAppLink(
                                                'Advanced UI/UX',
                                                isINR ? 450000 : Math.round(450000 / exchangeRate), // Midpoint
                                                isINR ? 'INR' : 'USD'
                                            )}
                                            className="btn btn-light rounded-pill px-4 py-2"
                                            target="_blank"
...
export default ServicePriceDetails3;