...
import Us from '../../../assets/images/about-us.png';
    ...
    return (
        ...
        <div className="container">
            ...
            <div className="col-lg-5">
                ...
                <h1>Excellence unfolds with every click</h1>
                <p className="lead mb-0 mt-4">
                At ZDart, we are dedicated to keeping abreast of the latest trends and technologies in our field. Our commitment to transparency, communication, and customer satisfaction is unwavering.<br/> With ZDart, rest assured that you are in capable hands, 
                and we are committed to helping you realize your online potential.
                </p>
                <Link className="btn btn-primary mt-4" to="/about">Know About Us</Link>
                </div>
            </div>
            <div className="col-lg-7 text-center text-lg-end">
                <img loading="lazy" decoding="async" src={Us} alt="About Ourselves" className="img-fluid" />
            </div>
            </div>
        </div>
        <div className="has-shapes">
        <svg className="shape shape-left text-light" width="381" height="443" viewBox="0 0 381 443" fill="none"
        ...
        <svg className="shape shape-right text-light" width="406" height="433" viewBox="0 0 406 433" fill="none"
        xmlns="http://www.w3.org/2000/svg">
        <path
