...
import img from '../../../assets/images/testimonials/01.jpg';
        ...
        <div className="row position-relative">
            ...
            <div className="shadow rounded bg-white p-4 mt-4">
                ...
                <img loading="lazy" decoding="async"
                        src={img}
                    alt="Devon Lane" className="img-fluid" width="65" height="66"/>
                <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
                    <h4 className="h5 mb-1">Devon Lane</h4>
                    <p className="mb-0">Nursing Assistant</p>
                </div>
                </div>
                <div className="content">Lorem ipsum dolor <a href="http://google.com">@reamansimond</a> demina egestas sit purus
            ...
            <div className="shadow rounded bg-white p-4 mt-4">
                ...
                <img loading="lazy" decoding="async"
                src={img}
                alt="Bessie Cooper" className="img-fluid" width="65" height="66"/>
                <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
            ...
            <div className="shadow rounded bg-white p-4 mt-4">
                ...
                <img loading="lazy" decoding="async"
                src={img}
                    alt="Kathryn Murphy" className="img-fluid" width="65" height="66"/>
                <div className="mt-3 mt-sm-0 ms-0 ms-sm-3">
