...
import Banner from "../assets/images/payment-info.png";
import Video from "../assets/videos/ZDart.mp4"; // Import the video
...
const ApplyLoanModal = () => {
  ...
  return (
    <div id="applyLoan" tabIndex="-1" aria-labelledby="applyLoanLabel" aria-hidden="true">
      <section className="banner bg-tertiary position-relative overflow-hidden">
          ...
          <div className="row align-items-center justify-content-center">
            <div className="col-lg-6 mb-5 mb-lg-0">
              <div className="block text-center text-lg-start pe-0 pe-xl-5">
                <h1 className="text-capitalize mb-4">Optimize Your Website With ZDart<span>.</span></h1>
                <p className="mb-4">
            ...
            <div className="col-lg-6">
              <div className="ps-lg-5 text-center position-relative">
                <img
                  loading="lazy"
                  decoding="async"
                  src={Banner}
                  alt="banner"
                  className={`w-100 ${isVideoPlaying ? "d-none fade-out" : "fade-in"}`}
                />
                <video
                  ref={videoRef}
                  className={`w-100 ${isVideoPlaying ? "fade-in" : "d-none fade-out"}`}
                  controls
                  muted
                ...
                >
                  ...
                  <source src="../assets/videos/ZDart.webm" type="video/webm" />
        ...
        <div className="has-shapes">
          <svg className="shape shape-left text-light" viewBox="0 0 192 752" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
              d="M-55.5959 7.52271C-66.0565 43.9475 -47.4274 83.3312 -20.4214 109.92C6.58466 136.51 41.1549 153.722 72.9328 174.393C104.711 195.064 135.426 221.425 147.449 257.37C168.829 321.322 125.174 386.420 104.356 450.559C72.8494 547.601 97.3965 660.752 166.287 736.018"
              stroke="currentColor" strokeMiterlimit="10"
            />
            <path
          ...
          <svg className="shape shape-right text-light" viewBox="0 0 731 746" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            />
            <path
              d="M817.266 289.466C813.108 259.989 787.151 237.697 759.261 227.271C731.372 216.846 701.077 215.553 671.666 210.904C642.254 206.24 611.795 197.156 591.664 175.224C555.853 136.189 566.345 75.5336 560.763 22.8649C552.302 -56.8256 498.487 -130.132 425 -162.081"
              stroke="currentColor" strokeMiterlimit="10"
            />
            <path
