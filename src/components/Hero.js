...
// import Banner from '../assets/images/banner/banner.png'   // payment-info.png
import Banner from '../assets/images/payment-info.png'   // payment-info.png
          ...
          <div className="row align-items-center justify-content-center">
            ...
            <div className="col-lg-6">
              <div className="ps-lg-5 text-center">
                <img loading="lazy" decoding="async" src={Banner} alt="banner" className="w-100" />
              </div>
            </div>
          </div>
        </div>
